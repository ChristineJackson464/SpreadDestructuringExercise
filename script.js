...
// 3b. Using destructuring, set the value of the "Mickey Mouse Clubhouse" item to a variable called mickey. 
// Also, set the value of the "Spidey and His Amazing Friends" item to a variable called spidey.
...
// B-5a. Create a const variable named "all" and use the "bonus" object as well as spread to set the value of the "all" variable to an array with numbers 1 through 9 as the items (Example: [1, 2, 3, 4, 5, 6, 7, 8, 9])
// ! Incorrect: Answer via Review:
...
// B-5b. Create a variable for each of the nine numbers in the "bonus" object and set the number as the value for that using the spelled out name of each number as the variable name (Example: const one = 1, const two = 2, etc.). Also, must use destructuring to complete this.
// ! Did not attempt... 
// Answer via Review:
